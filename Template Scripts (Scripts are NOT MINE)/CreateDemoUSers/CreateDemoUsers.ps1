...
$orgShortName = "SG"                         # This is used to build a user's sAMAccountName
$dnsDomain = "SleepyGeeks"                      # Domain is used for e-mail address and UPN
$company = "SleepyGeeks"                           # Used for the user object's company attribute
...
[System.Collections.ArrayList]$phoneCountryCodes = @{"CA" = "+1"; "GB" = "+44"; "US" = "+1"}         # Country codes for the countries used in the address file
